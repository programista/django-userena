...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Message.safe'
        db.add_column('umessages_message', 'safe', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'Message.safe'
        db.delete_column('umessages_message', 'safe')
